                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-windows"></i> Thể Loại <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/the-loai/danh-sach')); ?>">Danh Sách</a></li>
                                    <li><a href="<?php echo e(url('admin/the-loai/them')); ?>">Thêm</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-paper-plane"></i> Truyện  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/truyen/danh-sach')); ?>">Danh Sách</a></li>
                                    <li><a href="<?php echo e(url('admin/truyen/them')); ?>">Thêm</a></li>
                                </ul>
                            </li>

							<li><a><i class="fa fa-bars"></i> Chương  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/chuong/danh-sach')); ?>">Danh Sách</a></li>
                                    <li><a href="<?php echo e(url('admin/chuong/them')); ?>">Thêm</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-bell"></i> Quảng Cáo  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/quang-cao/sua')); ?>">Sửa</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-sliders"></i> Slide  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/slide/them')); ?>">Thêm</a></li>
                                    <li><a href="<?php echo e(url('admin/slide/danh-sach')); ?>">Danh Sách</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-adjust"></i> Group Admin  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/group-admin/them')); ?>">Thêm</a></li>
                                    <li><a href="<?php echo e(url('admin/group-admin/danh-sach')); ?>">Danh Sách</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-dashcube"></i> Truyện Đọc Nhiều  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/truyen-doc-nhieu/them')); ?>">Thêm</a></li>
                                    <li><a href="<?php echo e(url('admin/truyen-doc-nhieu/danh-sach')); ?>">Danh Sách</a></li>
                                </ul>
                            </li>
