        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" action="<?php echo e(url('admin/truyen-doc-nhieu/them')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="select2_group form-control" name="chuong_id">
                                        ...
                                        <optgroup label="<?php echo e($item->ten); ?>">
                                            ...
                                            <option value="<?php echo e($chapter->id); ?>"><?php echo e($chapter->ten); ?></option>
