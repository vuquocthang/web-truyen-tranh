...
<?php $__env->startSection('breadcrumb'); ?>
        <ul class="breadcrumb">
            <li>
                <a href="<?php echo e(url('')); ?>"><i class="glyphicon glyphicon-home"></i> Trang chủ</a>
            </li>
            <li class="active">
                <a href="<?php echo e(url('truyen/' . $story->slug. '.html')); ?>"><?php echo e($story->ten); ?></a>
            </li>
        </ul>
    ...
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-6 margin-bottom-15px">
                <img class="img-thumbnail" src="<?php echo e(url('public/image/' . $story->image_link)); ?>" alt="<?php echo e($story->ten); ?>">
            </div>
            <div class="col-md-6 comic-info">
                <h2 class="info-title"><?php echo e($story->ten); ?></h2>
                <p>
                    <strong>Tên khác:</strong>
                    <span><?php echo e($story->ten_khac); ?></span>
                    <br> <strong>Tác giả:</strong> <span class="green"> Đang cập nhật
                                </span>
                    <br> <strong>Nhóm dịch:</strong> <?php echo e($story->nhom_dich); ?>

                    <br> <strong>Tình trạng:</strong> <span><?php echo e($story->tinh_trang); ?></span>
                    <br> <strong>Nguồn:</strong>
                    <span class="org">
                        <?php echo e($story->nguon); ?>

                    </span>
                    <br> <strong>Ngày thêm:</strong> <?php echo e((new \Carbon\Carbon($story->ngay_them))->format('d/m/Y')); ?></p>
        ...
        <div class="widget">
            ...
            <div class="table-wrapper">
                <table class="table table-striped">
                    ...
                    <?php $__currentLoopData = \App\Chapter::where('status', 1)->where('truyen_id', $story->id)->orderBy('ngay_them', 'DESC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <tr>
                        <td>
                            <a href="<?php echo e(url('truyen/' . $story->slug . '/' . $item->slug . '.html')); ?>"><?php echo e($story->ten); ?> – <?php echo e($item->ten); ?></a>
                        </td>

                        <td><?php echo e((new \Carbon\Carbon($item->ngay_them))->format('d/m/Y')); ?></td>
                    </tr>
